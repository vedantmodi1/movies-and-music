...
if(isset($_POST['submit']))
{
     ...
     if($user_type == 'yes')
     {
       ...
       $sql = "INSERT INTO user_student(user_id,user_name,university_name, university_email,contact_no) VALUES('$userid','$name','$uniname','$uniemailid', '$contactno')";
     }
     else
     {
      ...
      $sql1 = "INSERT INTO customer(user_id, user_name, email_id, password) VALUES('$userid', '$name', '$emailid', '$passw')";
